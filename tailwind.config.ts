  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-gain": "linear-gradient(135deg, hsl(var(--gain)) 0%, hsl(162 83% 35%) 100%)",
        "gradient-loss": "linear-gradient(135deg, hsl(var(--loss)) 0%, hsl(0 72% 40%) 100%)",
        "gradient-dark": "linear-gradient(180deg, hsl(222 47% 8%) 0%, hsl(222 47% 5%) 100%)",
        "gradient-card": "linear-gradient(135deg, hsl(222 47% 10%) 0%, hsl(222 47% 7%) 100%)",
      },
      boxShadow: {
        "glow-gain": "0 0 20px hsl(var(--gain) / 0.4)",
        "glow-loss": "0 0 20px hsl(var(--loss) / 0.4)",
